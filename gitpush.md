...
curl -s https://api.github.com/repos/IroScript/Note_in_Rust_AutoSave/commits/main | Select-String -Pattern '"sha"' | Select-Object -First 1
...
start https://github.com/IroScript/Note_in_Rust_AutoSave
...
- **Repository:** https://github.com/IroScript/Note_in_Rust_AutoSave
- **Default Branch:** main
